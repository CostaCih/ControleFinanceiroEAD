                ...
                <form action="realizar_movimento.php" method="POST">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="data" class="form-control" id="data" value="<?= isset($data) ? $data : '' ?>" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Digite o Valor (R$):</label>
                            <input type="text" name="valor" class="form-control" placeholder="Digite o valor aqui..." id="valor" value="<?= isset($valor) ? $valor : '' ?>" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <button class="btn btn-success" name="btnConfirmar">Realizar Movimento</button>
                    </div>
                </form>
            </div>
        </div>
