        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Digite o Nome da Empresa aqui..." name="nome" id="nome" maxlength="50" value="<?= $dados[0]['nome_empresa'] ?>" />
                </div>
                <div class="form-group">
                    <label>Digite o Telefone (WatsApp):</label>
                    <input class="form-control" placeholder="Digite o Telefone aqui..." name="telefone" id="telefone" value="<?= $dados[0]['telefone_empresa'] ?>" />
                </div>
                <div class="form-group">
