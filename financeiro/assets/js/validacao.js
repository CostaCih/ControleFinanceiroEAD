...
// Validação de Canpos: Tela de Cadastrar e Alterar/Excluir Empresa.
function ValidarEmpresa(){
    if($("#nome").val().trim() == '') {
        alert("Preencha o campo obrigatório NOME EMPRESA!");
        $("#nome").focus();
        return false;
    }
...
// Validação de Campos: Tela de Cadastrar e Alterar/Excluir Movimento.
