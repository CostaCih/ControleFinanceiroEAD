        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Digite a Agência aqui.." name="agencia" id="agencia" value="<?= $dados[0]['agencia_conta'] ?>" />
                </div>
                <div class="form-group">
                    <label>Digite o Número da Conta:</label>
                    <input class="form-control" placeholder="Digite o Número da Conta aqui..." name="numero" id="conta" value="<?= $dados[0]['numero_conta'] ?>" />
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success" name="btnSalvar" onclick="return ValidarEmpresa()">Alterar</button>
